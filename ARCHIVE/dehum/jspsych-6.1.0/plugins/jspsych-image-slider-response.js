...
jsPsych.plugins['image-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<p>People can vary in how human-like they seem.</p>'
    html += '<p>Some people seem highly evolved whereas others seem no different than lower animals.</p>'
    html += '<p>Using the image below, indicate using the slider how evolved you consider the average member of this group to be:</p>'
    html += '<p><strong>'+trial.prompt+'</strong></p>'
    ...
    html += '">';
    html += '<input type="range" value="'+trial.start+'" min="'+trial.min+'" max="'+trial.max+'" step="'+trial.step+'" style="width: 60%;" id="jspsych-image-slider-response-response"></input>';
    html += '<div>'
